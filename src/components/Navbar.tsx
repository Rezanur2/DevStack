    ...
    return (
        <nav className='border-b border-gray-200 sticky top-0 z-50 bg-white'>
            <div className='container mx-auto flex justify-between items-center px-3 sm:px-5 lg:px-8 py-3 lg:py-6'>
                ...
                <ul className='hidden md:flex text-[12px] md:text-sm lg:text-base xl:text-lg md:gap-3 lg:gap-6 font-medium text-[#475569] '>
                ...
                <div className='flex gap-0 sm:gap-1 lg:gap-3 text-xs md:text-sm lg:text-base xl:text-lg'>
