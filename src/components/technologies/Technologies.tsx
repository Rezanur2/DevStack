        ...
        <div className='container mx-auto px-6'>
            ...
            <div className='flex justify-between gap-4 mb-2'>
                <div className='space-y-2 mb-10'>
                    <h2 className='font-bold lg:font-extrabold [letter-spacing:-0.9px] text-2xl md:text-4xl lg:text-[42px] text-[#0F172A]'>Explore the <span className='bg-linear-to-r from-[#EC4899] to-[#8B5CF6] bg-clip-text text-transparent'>Technologies</span></h2>
